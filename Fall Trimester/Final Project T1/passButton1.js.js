...
var answer = prompt("Name one building on the Horace Mann campus. (Include only the first name, without the hall at end)");
var answerNew = answer.toLowerCase();

for (i = 0;i<possWords.length;i++) {

if (answerNew === possWords[i]) {
window.location.href = "mailto:nicholas_keirstead@horacemann.org?subject=About%20Your%20Website";
return;
}}
